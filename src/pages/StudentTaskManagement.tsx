...
const StudentTaskManagement = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-orange-950 to-amber-900 relative">
      {/* Geometric Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23fbbf24' fill-opacity='0.3'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
        }}></div>
      </div>

      {/* Header */}
      <header className="relative bg-gradient-to-r from-slate-900/70 to-orange-900/70 backdrop-blur-xl border-b border-orange-400/30 shadow-2xl">
      ...
      <main className="relative container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="text-center mb-16 relative">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-r from-orange-500/20 to-amber-500/20 mb-8 border border-orange-400/30">
            <Target className="w-10 h-10 text-orange-300" />
          </div>
          <h1 className="text-7xl font-bold text-white mb-6 bg-gradient-to-r from-orange-300 via-amber-300 to-yellow-300 bg-clip-text text-transparent font-mono tracking-wider">
            TaskFlow
          </h1>
          <p className="text-2xl text-orange-100/90 mb-8 max-w-4xl mx-auto leading-relaxed">
            Revolutionizing student productivity with intelligent task management and real-time collaboration
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-gradient-to-r from-orange-500/20 to-amber-500/20 rounded-full px-4 py-2 border border-orange-400/30">
              <span className="text-orange-200 text-sm font-medium">⚡ Real-time Sync</span>
            </div>
            <div className="bg-gradient-to-r from-amber-500/20 to-yellow-500/20 rounded-full px-4 py-2 border border-amber-400/30">
              <span className="text-amber-200 text-sm font-medium">🎯 Smart Prioritization</span>
            </div>
            <div className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-full px-4 py-2 border border-yellow-400/30">
              <span className="text-yellow-200 text-sm font-medium">📊 Analytics Dashboard</span>
            </div>
          </div>
